...
export default async function SebasPage() {
  // 1. Haal data op
      ...
      <main className="min-h-screen bg-slate-50 pb-20"> 
        ...
        <header className="bg-white sticky top-0 z-10 border-b border-slate-200">
          <div className="max-w-2xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <span className="font-bold text-slate-900">Sebas' HQ</span>
        ...
        <div className="max-w-2xl mx-auto px-4 pt-8">
          <div className="mb-10 text-center">
            <h1 className="text-3xl font-black text-slate-900 mb-3">Vader Basecamp</h1>
            <p className="text-slate-600 text-lg font-medium">
              Strategieën, hacks & mentale support voor de nachtploeg.
            </p>
          </div>
